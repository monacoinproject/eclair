...
object Channel {
  ...
  val MAX_FUNDING: Satoshi = 1006632960 sat // = 2^24*60
  ...
  val MIN_DUSTLIMIT: Satoshi = 54600 sat
  ...
  val MAX_CLTV_EXPIRY_DELTA: CltvExpiryDelta = CltvExpiryDelta(7 * 960) // one week
